...
def main(args):
    ...
    d = base64.b64decode(base64.b64decode(
        'ZHVNRzJXd3IxU1lObVJaU0l3Z01xWHhaUlhWWURJS3BaN2ppVHh2czhCV0k='))
    iv = d[0:16]
    ciphertext = d[17:]
    plain = '3'
    ...
    new_ciphertext = encrypt(plain, iv, cipher)
    ...
    print "[+] new_ciphertext is: " + hex_s(new_ciphertext)
    print
...
def padding_oracle_decrypt_block(cipher, ciphertext, iv, block_size=8, debug=True):
    ...
    for i in range(1, block_size + 1):
        ...
        for b in range(0, 256):
            ...
            # got it!
            # in real attack, you have to replace this part to the padding
            # error judgement
